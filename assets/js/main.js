...
(function() {
  ...
  if (preloader) {
    window.addEventListener('load', () => {
      ...
      // Force initial load to show the top of the main content, not a section with a hash
      if ('scrollRestoration' in history) {
        history.scrollRestoration = 'manual';
      }

      // Remove any hash in the URL (so refresh won't jump to a section)
      if (window.location.hash) {
        history.replaceState(null, '', window.location.pathname + window.location.search);
      }

      // Scroll to the start of <main class="main">
